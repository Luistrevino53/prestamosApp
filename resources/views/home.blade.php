                                ...
                                <form class="form-horizontal form-bordered" onsubmit="return false;"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            {{-- <input type="text" id="info-cst-promotor" name="info-cst-promotor"
                                                   class="form-control" placeholder="Promotor Asignado" disabled>
                                                   <input type="hidden" name="info-cst-promotor-id" id="info-cst-promotor-id"> --}}
                                        </div>
                                    </div>
                                    <div class="form-group">
